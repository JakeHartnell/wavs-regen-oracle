...
In [`/wavs-regen-oracle/src/lib.rs`](https://github.com/Lay3rLabs/wavs-foundry-template/tree/v0.3.0/components/wavs-regen-oracle/src/lib.rs) you'll find the oracle service component.
